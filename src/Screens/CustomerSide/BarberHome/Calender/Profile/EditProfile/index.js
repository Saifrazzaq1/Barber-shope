...
export default function BaberEditProfile({navigation}) {
  return (
    <ScrollView contentContainerStyle={{backgroundColor: '#E5E5E5'}}>
      <View style={styles.main}>
        <Header headerText="Edit Profile" navigation={navigation} />
        ...
        <View style={styles.cardsStyle}>
          <TouchableOpacity
            onPress={() => {
              navigation.navigate('BarberChangeNumber');
            }}>
            <HeaderCard
              color="#F5F5F5"
              flexDirection="row"
          ...
          />
          <TouchableOpacity onPress={() => console.log('Lucifer')}>
            <HeaderCard
              color="#1C3078"
              flexDirection="row"
